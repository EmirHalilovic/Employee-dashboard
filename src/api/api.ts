...
export type ProjectAllocationInnerLabelEnum = typeof ProjectAllocationInnerLabelEnum[keyof typeof ProjectAllocationInnerLabelEnum];
...
export type WorkplaceAllocationInnerLabelEnum = typeof WorkplaceAllocationInnerLabelEnum[keyof typeof WorkplaceAllocationInnerLabelEnum];
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Returns 20 randomized time change entries on each request
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listTimeChanges(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TimeChange>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listTimeChanges(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.listTimeChanges']?.[localVarOperationServerIndex]?.url;
...
export class DefaultApi extends BaseAPI {
    ...
    public listTimeChanges(options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).listTimeChanges(options).then((request) => request(this.axios, this.basePath));
    }
}
